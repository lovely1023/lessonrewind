...
(function() {
                ...
                g = function(a) {
                    b.call(this, a, function(a) {
                        ...
                        for (k in a) {
                            ...
                            if (!c[k]) {
                                if (m.icons)
                                    for (var j = m.icons.split(","), q = 0; q < j.length; q++) CKEDITOR.skin.addIcon(j[q], m.path + "icons/" + j[q] + ".png");
                                c[k] = 1
                            }
                            if (l) {
                                l.split && (l = l.split(","));
                ...
                if (b(m)) C.push(m);
                    ...
                    if (d == "br") x.push(m);
                        ...
                        for (;;) {
                            ...
                            if (!m.isUnknown && !i.isUnknown && !e[d])
    ...
    (function() {
        function b(b, c) {
            function m(a) {
                return a || CKEDITOR.env.ie ? new CKEDITOR.htmlParser.text("Â ") : new CKEDITOR.htmlParser.element("br", {
                    "data-cke-bogus": 1
                })
            }
        ...
        var A = /(?:&nbsp;|\xa0)$/,
            B = "{cke_protected}",
            p = CKEDITOR.dtd,
            F = ["caption", "colgroup", "col", "thead", "tfoot",
                "tbody"
            ],
                ...
                insertElement: function(b) {
                    ...
                    for (var c =
                        ...
                        if (!o.checkReadOnly()) {
                            ...
                            if (i)
                                for (;
                                    (F = o.getCommonAncestor(0, 1)) && (u = CKEDITOR.dtd[F.getName()]) && (!u || !u[n]);)
                                    if (F.getName() in CKEDITOR.dtd.span) o.splitElement(F);
                    ...
                    if (B) {
                        ...
                        if (i)
                            if ((b = B.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block)) b.getDtd()["#"] ? o.moveToElementEditStart(b) : o.moveToElementEditEnd(B);
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in {
                                ...
                                if (l = e(l)) {
                                    ...
                                    if ((j = f.block) && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && (n = j[c ? "getPrevious" : "getNext"](h)) && n.is("table")) {
                                        a.fire("saveSnapshot");
                                    ...
                                    if ((n = g[c ? "getPreviousSourceNode" : "getNextSourceNode"](1, CKEDITOR.NODE_ELEMENT)) && !n.isReadOnly() && b.root.contains(n)) {
                                        b[c ?
        ...
        var o = function() {
            ...
            return function(h, s, u) {
                ...
                if (!D.checkReadOnly()) {
                    ...
                    if (O)
                        for (; H =
                            O.pop();) H.append(CKEDITOR.env.ie ? J.document.createText("Â ") : J.document.createElement("br"));
                    ...
                    if (this.isLocked) {
                        ...
                        if (n) {
                            ...
                            if (p) {
                                ...
                                i.setHtml("&#65279;");
                                i.insertBefore(g);
                                h && b.document.createText("ï»¿").insertBefore(g)
                            }
                            b.setStartBefore(g);
                            g.remove();
                            if (a) {
                        ...
                        for (var g = C(this, c), q = g.hasAttributes(), s = k.getCommonAncestor(), p = {}, r = {}, u = {}, x = {}, A, B, F; g && s;) {
                            if (s.getName() == d) {
                                for (A in e.attributes)
                                    if (!x[A] && (F = s.getAttribute(B))) g.getAttribute(A) == F ? r[A] = 1 : x[A] = 1;
                                for (B in e.styles)
                                    if (!u[B] && (F = s.getStyle(B))) g.getStyle(B) == F ? p[B] = 1 : u[B] = 1
                            }
                            s = s.getParent()
                        }
            ...
            function k(a, c) {
                ...
                if (!d.getById("cke_pastebin")) {
                    var h = b.getSelection(),
                        o = h.createBookmarks(),
                        i = new CKEDITOR.dom.element(j.is("body") && !CKEDITOR.env.ie &&
            ...
            arrayToList: function(c, j, f, b, i) {
                ...
                for (var e, h = c[f].parent.getDocument(), g = new CKEDITOR.dom.documentFragment(h), a = null, d = f, m = Math.max(c[f].indent, 0), k = null, n, l, p = b == CKEDITOR.ENTER_P ? "p" : "div";;) {
                    ...
                    if (o.indent == m) {
                        ...
                        d++
                    } else if (o.indent == Math.max(m, 0) + 1) l = c[d - 1].element.getDirection(1), d = CKEDITOR.plugins.list.arrayToList(c, null, d, b, l != n ? n : null), !k.getChildCount() && (CKEDITOR.env.ie && !(7 < h.$.documentMode)) && k.append(h.createText("Â ")), k.append(d.listNode), d = d.nextIndex;
                    ...
                    onRender: function() {
                        d.on("selectionChange", function(a) {
                            for (var d = this.getValue(), a = a.data.path.elements, b = 0, f = a.length, e; b < f; b++) {
                                e = a[b];
                                for (var c in h)
                                    if (h[c].checkElementRemovable(e, !0)) {
                                        c != d && this.setValue(c);
                                        return
                                    }
                            }
        ...
        var g = function(a) {
            if (a.window) {
                ...
                if (!(c && c.state == CKEDITOR.TRISTATE_ON)) {
                    var c = h(a),
                        d = a.window.getViewPaneSize().height,
                        b;
                    b = c.getStyle("overflow-y");
                    var f = c.getDocument(),
                        e = CKEDITOR.dom.element.createFromHtml('<span style="margin:0;padding:0;border:0;clear:both;width:1px;height:1px;display:block;">' + (CKEDITOR.env.webkit ? "&nbsp;" : "") + "</span>", f);
                    f[CKEDITOR.env.ie ?
                        "getBody" : "getDocumentElement"]().append(e);
                    ...
                    b = Math.min(b, e);
                    b != d && (b = a.fire("autoGrow", {
                        currentHeight: d,
                        newHeight: b
                    }).newHeight, a.resize(a.container.getStyle("width"), b, !0));
        ...
        CKEDITOR.plugins.add("autogrow", {
            init: function(a) {
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) a.on("instanceReady", function() {
                    if (a.editable().isInline()) a.ui.space("contents").setStyle("height", "auto");
                    else {
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,a11yhelp,dialogadvtab,basicstyles,bidi,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,templates,menu,contextmenu,div,resize,toolbar,elementspath,list,indent,enterkey,entities,popup,filebrowser,find,floatingspace,listblock,richcombo,font,fakeobjects,forms,format,htmlwriter,horizontalrule,iframe,wysiwygarea,image,smiley,justify,link,liststyle,magicline,maximize,newpage,pagebreak,pastetext,pastefromword,preview,print,removeformat,save,selectall,showblocks,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc,autogrow,symbol';
    CKEDITOR.config.skin = 'moono';
    (function() {
		
			 var icons = ('about,0,bold,32,italic,64,strike,96,subscript,128,superscript,160,underline,192,bidiltr,224,bidirtl,256,blockquote,288,copy-rtl,320,copy,352,cut-rtl,384,cut,416,paste-rtl,448,paste,480,bgcolor,512,textcolor,544,templates-rtl,576,templates,608,creatediv,640,bulletedlist-rtl,672,bulletedlist,704,numberedlist-rtl,736,numberedlist,768,indent-rtl,800,indent,832,outdent-rtl,864,outdent,896,find-rtl,928,find,960,replace,992,button,1024,checkbox,1056,form,1088,hiddenfield,1120,imagebutton,1152,radio,1184,select-rtl,1216,select,1248,textarea-rtl,1280,textarea,1312,textfield-rtl,1344,textfield,1376,horizontalrule,1408,iframe,1440,image,1472,smiley,1504,justifyblock,1536,justifycenter,1568,justifyleft,1600,justifyright,1632,anchor-rtl,1664,anchor,1696,link,1728,unlink,1760,maximize,1792,newpage-rtl,1824,newpage,1856,pagebreak-rtl,1888,pagebreak,1920,pastetext-rtl,1952,pastetext,1984,pastefromword-rtl,2016,pastefromword,2048,preview-rtl,2080,preview,2112,print,2144,removeformat,2176,save,2208,selectall,2240,showblocks-rtl,2272,showblocks,2304,source-rtl,2336,source,2368,specialchar,2400,scayt,2432,table,2464,redo-rtl,2496,redo,2528,undo-rtl,2560,undo,2592,spellchecker,2624,symbol,2656'),
