...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            define: function(b, e) {
                var g = a.call(this, b);
                CKEDITOR.tools.extend(g, e, true)
            },
            on: function(b, e, g, d, m) {
                function j(a, f, n, s) {
                    a = {
                        name: b,
                        sender: this,
                    ...
                    return e.call(g, a) === false ? false : a.data
                }
            ...
            fire: function() {
                ...
                return function(m, j, i) {
                    ...
                    if (n) {
                        var r = n.listeners;
                        if (r.length)
                            for (var r = r.slice(0), v, f = 0; f < r.length; f++) {
                                if (n.errorProof) try {
                                    v = r[f].call(this,
                                        i, j, e, h)
                                } catch (q) {} else v = r[f].call(this, i, j, e, h);
                                v === false ? a = 1 : typeof v != "undefined" && (j = v);
                                if (b || a) break
                            }
                    }
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            buildStyleHtml: function(b) {
                for (var b = [].concat(b), a, e = [], g = 0; g < b.length; g++)
                    if (a = b[g]) /@import|[{}]/.test(a) ? e.push("<style>" + a + "</style>") : e.push('<link type="text/css" rel=stylesheet href="' + a + '">');
                return e.join("")
            },
            ...
            setTimeout: function(b, a, e, g, d) {
                d || (d = window);
                e || (e = d);
                return d.setTimeout(function() {
                    g ? b.apply(e, [].concat(g)) :
                        b.apply(e)
                }, a || 0)
            },
            trim: function() {
            ...
            normalizeCssText: function(a, c) {
                var e = [],
                    g, d = CKEDITOR.tools.parseCssText(a, true, c);
            ...
            convertArrayToObject: function(a, c) {
                ...
                for (var g = 0, d = a.length; g < d; ++g) e[a[g]] = c;
                return e
            },
            fixDomain: function() {
                for (var a;;) try {
            ...
            for (var b = this.$.documentElement, c =
                ...
                if (d)
                    for (var g = -1, h = 0; h < b.childNodes.length; h++) {
                        ...
                        if (!(d === true && m.nodeType == 3 && m.previousSibling && m.previousSibling.nodeType == 3)) {
                            g++;
                            if (g == e) {
                                b = m;
                                break
    ...
    (function() {
        ...
        function b(a) {
            for (var b = 0, d = 0, m = c[a].length; d < m; d++) b = b + (parseInt(this.getComputedStyle(c[a][d]) || 0, 10) || 0);
            return b
        }
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], j = 0; j < c.length; j++)
                        if (d)
                            for (var i = 0; i < d.length; i++) b.push([a, c[j], d[i]].join("-"));
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    ...
                    if (f) {
                        b = n.left + (!i && s.scrollLeft || j.$.scrollLeft);
                        b = b - v;
                        c = n.top + (!i && s.scrollTop || j.$.scrollTop);
                        c = c - r
                    }
                } else {
                    j = this;
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function r(a, b) {
                    ...
                    c = a.getWindow();
                    if (!c.equals(b)) {
                        c = r(CKEDITOR.dom.element.get(c.$.frameElement), b);
                        e.x = e.x + c.x;
                        e.y = e.y + c.y
                    }
                    return e
                ...
                var u = a.$.clientHeight,
                    p =
                    a.$.clientWidth;
                i = j.x - v(this, "left") - q.x || 0;
                n = j.y - v(this, "top") - q.y || 0;
                d = j.x + d + v(this, "right") - (q.x + p) || 0;
                j = j.y + A + v(this, "bottom") - (q.y + u) || 0;
                if (n < 0 || j > 0) s(0, b === true ? n : b === false ? j : n < 0 ? n : j);
                if (c && (i < 0 || d > 0)) s(i < 0 ? i : d, 0)
            },
    ...
    (function() {
        function a(a, b) {
            ...
            var n = c.startOffset,
                ...
                g, k = this.guard,
                l = this.type,
                t = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var j = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(),
                    o = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(d) : f.getNext();
                this._.guardLTR = function(a, b) {
                    return (!b || !j.equals(a)) && (!o ||
                        !a.equals(o)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var h = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(),
                    i = e.type == CKEDITOR.NODE_ELEMENT ? n ? e.getChild(n - 1) : null : e.getPrevious();
            ...
            if (this.current) f = this.current[t](false, l, g);
            else {
                if (a) f.type ==
                    CKEDITOR.NODE_ELEMENT && (f = d > 0 ? f.getChild(d - 1) : g(f, true) === false ? null : f.getPreviousSourceNode(true, l, g));
                else {
                    f = e;
                    if (f.type == CKEDITOR.NODE_ELEMENT && !(f = f.getChild(n))) f = g(e, true) === false ? null : e.getNextSourceNode(true, l, g)
                }
                f && g(f) === false && (f = null)
            }
            for (; f && !this._.end;) {
        ...
        CKEDITOR.dom.walker.bookmark = function(a, b) {
            ...
            return function(f) {
                var e, n;
                e = f && f.type != CKEDITOR.NODE_ELEMENT && (n = f.getParent()) && c(n);
                e = a ? e : e || c(f);
                return !!(b ^ e)
            }
        };
        ...
        var c = function(a) {
            ...
            e = function(a, b, c, e) {
                ...
                var f = a.startContainer,
                    ...
                    j = a.endOffset,
                    p, k;
                if (d.type == CKEDITOR.NODE_TEXT) d = d.split(j);
                else if (d.getChildCount() > 0)
                    if (j >= d.getChildCount()) {
                ...
                for (var o = c, i, G, m, C = l; C < g.length; C++) {
                    i =
                        g[C];
                    o && !i.equals(f) && (G = o.append(i.clone()));
                    for (i = i.getNext(); i;) {
                        if (i.equals(j[C]) || i.equals(d)) break;
                        m = i.getNext();
                ...
                o = c;
                for (c = l; c < j.length; c++) {
                    i = j[c];
                    b > 0 && !i.equals(d) && (G = o.append(i.clone()));
                ...
                if (b == 2) {
                    ...
                    if (t.type == CKEDITOR.NODE_TEXT) {
                        t.$.data = t.$.data + t.$.nextSibling.data;
                    ...
                    if (t && h && (f.$.parentNode != t.$.parentNode || d.$.parentNode != h.$.parentNode)) {
                        b = h.getIndex();
                        p && h.$.parentNode == f.$.parentNode && b--;
                        if (e && t.type == CKEDITOR.NODE_ELEMENT) {
                            e = CKEDITOR.dom.element.createFromHtml('<span data-cke-bookmark="1" style="display:none">&nbsp;</span>',
                                a.document);
                            e.insertAfter(t);
                            t.mergeSiblings(false);
                            a.moveToBookmark({
                                startNode: e
                            })
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        if (o.type == CKEDITOR.NODE_TEXT) {
                            if (m) {
                                o = !CKEDITOR.tools.trim(o.substring(0,
                                    m)).length && o;
                                i = !!o
                            }
                            if (o && !(l = o.getPrevious())) k = o.getParent()
                        } else {
                            m && (l = o.getChild(m - 1) || o.getLast());
                            l || (k = o)
                        }
                        for (k = c(k); k || l;) {
                            if (k && !l) {
                            ...
                            for (; l;) {
                                ...
                                if (l.type == CKEDITOR.NODE_COMMENT) l = l.getPrevious();
                                    ...
                                    if (l.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        if (i && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                            ...
                                            if (e.test(h)) l = null;
                                                ...
                                                for (var m = l.$.getElementsByTagName("*"), I = 0, C; C = m[I++];)
                                    ...
                                    o && (i ? t ? j = k : k && this.setStartBefore(k) : i = true);
                                    if (l) {
                                        o = l.getPrevious();
                                        if (!k && !o) {
                                            k = l;
                        ...
                        var N = function(a, b) {
                            ...
                            for (c.guard = function(a) {
                                ...
                                if (e.test(h)) return false
                            }
                            return true
                        };
                        if (o.type == CKEDITOR.NODE_TEXT)
                            if (CKEDITOR.tools.trim(o.substring(m)).length) i = true;
                            else {
                                i = !o.getLength();
                                if (m == o.getLength()) {
                                    if (!(l = o.getNext())) k = o.getParent()
                                } else N(o,
                                    m) && (k = o.getParent())
                            } else(l = o.getChild(m)) || (k = o);
                        for (; k || l;) {
                            if (k && !l) {
                                !t && k.equals(d) && (t = true);
                                if (f ? k.isBlockBoundary() : !g.contains(k)) break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var H, w, x = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                                br: 1
                            } : null),
                            D = null,
                            E = function(a) {
                        ...
                        k = k.lastBackward();
                        H = H || g;
                        this.setStartAt(H, !H.is("br") && (!k && this.checkStartOfBlock() || k && H.contains(k)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        ...
                        k = new CKEDITOR.dom.walker(k);
                        k.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : E;
                        H = null;
                        k = k.lastForward();
                        H = H || g;
                        this.setEndAt(H, !k && this.checkEndOfBlock() || k && H.contains(k) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    if (f && f.type == CKEDITOR.NODE_TEXT)
                        if (g)
                            if (g >= f.getLength()) e.setStartAfter(f);
                            else {
                                e.setStartBefore(f);
                                p = 0
                    ...
                    if (d && d.type == CKEDITOR.NODE_TEXT)
                        if (i)
                            if (i >= d.getLength()) e.setEndAfter(d);
                            else {
                                e.setEndAfter(d);
                                k = 0
                    ...
                    e.guard = function(b, e) {
                        if (l(b)) return true;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || e && b.equals(t) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() ||
                            b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return false;
                        !e && b.type == CKEDITOR.NODE_ELEMENT && (t = b);
                        return true
                    };
                    if (p)(f = e[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(f, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                    if (k) {
                        e.reset();
            ...
            moveToElementEditablePosition: function(a, b) {
                ...
                for (var c = 0; a;) {
                    ...
                    var e = a,
                        f = c,
                        d = void 0;
                    e.type == CKEDITOR.NODE_ELEMENT && e.isEditable(false) && (d = e[b ? "getLast" : "getFirst"](i));
                    !f && !d && (d = e[b ? "getPrevious" : "getNext"](i));
                    a = d
                }
                return !!c
            },
    ...
    (function() {
        ...
        function c(a, e, d, g) {
            ...
            if (!g) return 0;
            if ((h = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !h.check(e)) return c(a, e, d, g.remaining);e = new CKEDITOR.dom.range(g.element);e.selectNodeContents(g.element);e = e.createIterator();e.enlargeBr = a.enlargeBr;e.enforceRealBlocks = a.enforceRealBlocks;e.activeFilter = e.filter = h;a._.nestedEditable = {
                element: g.element,
                container: d,
            ...
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; q;) {
                    var A = 0,
                        ...
                        p = q.type != CKEDITOR.NODE_ELEMENT,
                        k = 0;
                    if (p) q.type == CKEDITOR.NODE_TEXT && e.test(q.getText()) && (p = 0);
                    else {
                        var l = q.getName();
                        if (CKEDITOR.dtd.$block[l] && q.getAttribute("contenteditable") == "false") {
                            b = q;
                            c(this, a, b);
                            break
                            ...
                            if (h) {
                                h.setEndAt(q, CKEDITOR.POSITION_BEFORE_START);
                                if (l != "br") this._.nextNode = q
                            }
                            A = 1
                        } else {
                            if (q.getFirst()) {
                                if (!h) {
                                    h = this.range.clone();
                                    h.setStartAt(q, CKEDITOR.POSITION_BEFORE_START)
                                }
                                q = q.getFirst();
                                continue
                            }
                    ...
                    if (h && !A)
                        for (; !q.getNext(m) && !s;) {
                            l = q.getParent();
                            if (l.isBlockBoundary(this.forceBrBreak && !u && {
                                    br: 1
                                })) {
                                A = 1;
                                p = 0;
                    ...
                    p && h.setEndAt(q, CKEDITOR.POSITION_AFTER_END);
                    q = d(q, k, f);
                    if ((s = !q) || A && h) break
                }
                if (!b) {
                    ...
                    b = b.block;
                    if (!b && q && !this.enforceRealBlocks && A[q.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !q.equals(h.root)) b = q;
                    ...
                    } else if (!s) this._.nextNode = b.equals(f) ? null : d(h.getBoundaryNodes().endNode, 1, f)
                }
                ...
                if (v)(r = b.getLast()) && r.type == CKEDITOR.NODE_ELEMENT && r.getName() == "br" && (!CKEDITOR.env.needsBrFiller || r.getPrevious(g) || r.getNext(g)) && r.remove();
    ...
    (function() {
                    ...
                    a: if (a.nothingRequired) f = true;
                            ...
                            if (z = a.requiredClasses) {
                                ...
                                for (f = 0; f < z.length; ++f)
                                    if (CKEDITOR.tools.indexOf(k, z[f]) == -1) {
                                        f = false;
                                        break a
                                    }
                            }
                    ...
                    if (!c.allClasses) {
                        ...
                        if (a)
                            if (a === true) b = true;
                                ...
                                for (var z = 0, k = b.length, l; z < k; ++z) {
                                    l = b[z];
                                    f[l] || (f[l] = a(l))
                                }
                                b = false
        ...
        function c(b) {
            ...
            return b._.filterFunction = function(f, d, k, l, g, p, h) {
                var o = f.name,
                    t, A = false;
                if (g) f.name = o = o.replace(c, "$1");
                if (k = k && k[o]) {
                    j(f);
                    for (o = 0; o < k.length; ++o) q(b, f, k[o]);
                    i(f)
                }
                if (d) {
                    var o = f.name,
                    ...
                    if (k) {
                        o = 0;
                        for (t = k.length; o < t; ++o) a(k[o], f, d, true, p)
                    }
                    if (u) {
                        o = 0;
                        for (t = u.length; o < t; ++o) a(u[o], f, d, false, p)
                    }
                    if (!d.valid) {
                        l.push(f);
                        return true
                    ...
                    if (!d.allAttributes)
                        for (y in t)
                            if (!p[y])
                                if (r.test(y)) {
                                    if (y != (G = y.replace(/^data-cke-saved-/, "")) &&
                                        !p[G]) {
                                        delete t[y];
                                        s = true
                                    }
                    ...
                    if (d.allStyles) {
                        ...
                        for (y in u) o[y] ? C.push(y + ":" + u[y]) : s = true;
                        if (C.length) t.style = C.sort().join("; ")
                    }
                    if (d.allClasses) m && (t["class"] = m);
                    else {
                        for (y in k) k[y] && I.push(y);
                        I.length && (t["class"] = I.sort().join(" "));
                        m && I.length < m.split(/\s+/).length && (s = true)
                    }
                    s && (A = true);
                    if (!h && !n(f)) {
                        l.push(f);
                ...
                if (g) f.name = f.name.replace(e, "cke:$1");
                return A
            }
        }
        ...
        function g(a) {
            if (!a) return {};
            for (var a = a.split(/\s*,\s*/).sort(), b = {}; a.length;) b[a.shift()] = o;
            return b
        }

        function h(a) {
            for (var b, c, e, f, d = {}, k = 1, a = y(a); b = a.match(C);) {
                if (c = b[2]) {
                    e = m(c, "styles");
                    f = m(c, "attrs");
                    c = m(c, "classes")
        ...
        function f(a, b, c) {
            var e = a.name;
            if (l.$empty[e] || !a.children.length)
                if (e == "hr" && b == "br") a.replaceWith(r());
                else {
                    a.parent && c.push({
                        check: "it",
                        el: a.parent
                    ...
                    a.remove()
                } else if (l.$block[e] || e == "tr")
                if (b == "br") {
                    if (a.previous && !v(a.previous)) {
                        b = r();
                        b.insertBefore(a)
                    }
                    if (a.next && !v(a.next)) {
                    ...
                    b: {
                        f = l[b];
                        for (var d = 0, k = e.length, g; d < k; ++d) {
                            g = e[d];
                            if (g.type ==
                                CKEDITOR.NODE_ELEMENT && !f[g.name]) {
                                f = false;
                                break b
                            }
                        }
                    ...
                    if (f) {
                        ...
                        f = a.parent;
                        for (var d = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body", q, k = e.length; k > 0;) {
                            g = e[--k];
                            if (d && (g.type == CKEDITOR.NODE_TEXT || g.type == CKEDITOR.NODE_ELEMENT && l.$inline[g.name])) {
                                if (!q) {
                                ...
                                q = null;
                                g.insertAfter(a);
                                f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (g.type ==
                                    CKEDITOR.NODE_ELEMENT && !l[f.name][g.name]) && c.push({
                                    check: "el-up",
                                    el: g
                                })
                            }
        ...
        function A(a, b) {
            ...
            for (d in e)
                if (d == "class") {
                    c = e[d].split(/\s+/);
                    for (l = a.classes.join("|"); g =
                        c.pop();)
                        if (l.indexOf(g) == -1) return false
        ...
        CKEDITOR.filter = function(a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                if (b === true) this.disabled = true;
                    ...
                    this.allow(J[a.enterMode] + " " + J[a.shiftEnterMode],
                        "default", 1)
                }
            } else {
        ...
        CKEDITOR.filter.prototype = {
            allow: function(a, c, e) {
                ...
                for (l = e.length; d < l; ++d) {
                    ...
                    if (g.elements === true || g.elements === null) {
                        g.elements = s(g.elements);
                        a[q ? "unshift" : "push"](g)
                    } else {
                        o = g.elements;
                        delete g.elements;
                        for (f in o)
                            if (k[f]) k[f][q ? "unshift" : "push"](g);
                            else k[f] = [g]
                    }
                }
                c.elements = k;
            ...
            applyTo: function(a, b, e, d) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if (a.attributes["data-cke-filter"] ==
                            "off") return false;
                        if (!b || !(a.name == "span" && ~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))) o(a, g, q, k, b) && (h = true)
                        ...
                        a: {
                            ...
                            if (p)
                                for (d = 0; d < p.length; ++d)
                                    if ((l = e.match(p[d])) && l[0].length == e.length) {
                                        c = true;
                                        break a
                                    }
                ...
                k.length && (h = true);
                for (var t, a = [], d = J[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; e = k.pop();) e.type == CKEDITOR.NODE_ELEMENT ? f(e, d, a) : e.remove();
                for (; t = a.pop();) {
                    e = t.el;
                    if (e.parent) switch (t.check) {
                        case "it":
                            l.$removeEmpty[e.name] && !e.children.length ? f(e, d, a) : n(e) || f(e, d, a);
                            break;
                        case "el-up":
                            e.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !l[e.parent.name][e.name] && f(e, d, a);
                            break;
                        case "parent-down":
                            e.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                                !l[e.parent.name][e.name] && f(e.parent, d, a)
                    }
                }
                return h
            },
            ...
            addContentForms: function(a) {
                if (!this.disabled && a) {
                    ...
                    if (f) {
                        for (b = 0; b < a.length; ++b) e.push(u(a[b], f));
                ...
                if (!this.disabled && a) {
                    ...
                    for (f = 0; f < a.length; ++f) {
                        ...
                        for (l = 0; l < b.length; ++l) {
                            ...
                            if (!d) {
                                d = g;
                                d = d.element ? d.element : q ? q.match(/^([a-z0-9]+)/i)[0] : d.left.getDefinition().element
                            }
                            o instanceof CKEDITOR.style && (o = p(o));
                            c.push({
                                check: q == d ? null : q,
                                left: o,
                                right: typeof h == "string" ? k(h) : h
                            })
                        }
                        b = d;
                        e[b] || (e[b] = []);
            ...
            check: function(a, b, e) {
                ...
                if (typeof a == "string") {
                    ...
                    var l = f.classes;
                    f.name = f.elements;
                    f.classes = l = l ? l.split(/\s*,\s*/) : [];
                    f.styles = g(d);
                    f.attributes = g(f.attributes);
                    f.children = [];
                    l.length && (f.attributes["class"] = l.join(" "));
                ...
                var l = CKEDITOR.tools.clone(d),
                    o = [],
                    p;
                if (b !== false && (p = this._.transformations[d.name])) {
                    for (f = 0; f < p.length; ++f) q(this, d, p[f]);
                    i(d)
                }
                c(this)(l, this._.rules, b === false ? false : this._.transformations, o, false, !e, !e);
                b = o.length > 0 ? false : CKEDITOR.tools.objectCompare(d.attributes, l.attributes, true) ? true : false;
            ...
            H = CKEDITOR.filter.transformationsTools = {
                ...
                lengthToAttribute: function(a, b, c) {
                    ...
                    if (!(c in a.attributes)) {
                        var e = a.styles[b],
                            f = e && e.match(/^(\d+)(?:\.\d*)?px$/);
                        f ? a.attributes[c] = f[1] : e == o && (a.attributes[c] =
                            o)
                    }
                    delete a.styles[b]
                },
                    ...
                    if (typeof b == "string") a.name = b;
                        ...
                        for (d in f)
                            if (d ==
                                "class") {
                                c = a.classes.join("|");
                                for (l = f[d].split(/\s+/); g = l.pop();) c.indexOf(g) == -1 && a.classes.push(g)
                            } else a.attributes[d] = f[d];
                        for (k in e) a.styles[k] = e[k]
                    }
                }
            }
    })();
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function(a, d, b) {
            ...
            for (var c = this.loaded, e = this.registered, g = [], h = {}, m = {}, j = 0; j < a.length; j++) {
                var i = a[j];
                if (i)
                    if (!c[i] && !e[i]) {
            ...
            CKEDITOR.scriptLoader.load(g, function(a, e) {
                ...
                for (var g = 0; g < a.length; g++)
                    for (var f = h[a[g]], q = 0; q < f.length; q++) {
                        var j = f[q];
                        m[j] = this.get(j);
                        c[j] = 1
                    }
                ...
                h = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (m in a) {
                            ...
                            if (!d[m]) {
                                if (s.icons)
                                    for (var v = s.icons.split(","), f = v.length; f--;) CKEDITOR.skin.addIcon(v[f], s.path + "icons/" + (CKEDITOR.env.hidpi && s.hidpi ? "hidpi/" : "") + v[f] + ".png");
                                d[m] = 1
                            }
                            if (r) {
                                r.split && (r = r.split(","));
                                for (s = 0; s < r.length; s++) g[r[s]] || b.push(r[s])
                            }
                        }
        ...
        function n(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var g in c) {
                    ...
                    if (i && (w = i.match(l)))
                        for (; i = w.pop();) CKEDITOR.tools.setTimeout(function(a, b) {
                            throw Error('Plugin "' + a.replace(",", "") + '" cannot be removed from the plugins list, because it\'s required by "' +
                                b + '" plugin.');
                        }, 0, null, [i, g]);
                    if (h && !a.lang[g]) {
                        h.split && (h = h.split(","));
                        if (CKEDITOR.tools.indexOf(h, a.langCode) >= 0) j = a.langCode;
                        else {
                            j = a.langCode.replace(/-.*/, "");
                            j = j != a.langCode && CKEDITOR.tools.indexOf(h, j) >= 0 ? j : CKEDITOR.tools.indexOf(h, "en") >= 0 ? "en" : h[0]
                        }
                        if (!p.langEntries || !p.langEntries[j]) k.push(CKEDITOR.getUrl(p.path + "lang/" + j + ".js"));
                        else {
                            a.lang[g] = p.langEntries[j];
                            j = null
                        }
                    }
                    d.push(j);
                ...
                CKEDITOR.scriptLoader.load(k, function() {
                    for (var c = ["beforeInit", "init", "afterInit"], k = 0; k < c.length; k++)
                        for (var l =
                                0; l < e.length; l++) {
                            var g = e[l];
                            k === 0 && (d[l] && g.lang && g.langEntries) && (a.lang[g.name] = g.langEntries[d[l]]);
                            if (g[c[k]]) g[c[k]](a)
                        }
                        ...
                        if (!/="/.test(e)) {
                            ...
                            if (c)
                                for (; j = a.exec(c);) {
                                    ...
                                    j = j[2] || j[3] || j[4] || "";
                                    m[n] = !j && d[n] ? n : CKEDITOR.tools.htmlDecodeAttr(j)
                                }
                            this.onTagOpen(e, m, i);
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(e, g, h) {
            function m(a) {
                var b;
                if (q.length > 0)
                    for (var c = 0; c < q.length; c++) {
                        var e =
                            ...
                            d = e.name,
                            f = CKEDITOR.dtd[d],
                            k = u.name && CKEDITOR.dtd[u.name];
                        if ((!k || k[d]) && (!a || !f || f[a] || !CKEDITOR.dtd[a])) {
                            if (!b) {
                                j();
                                b = 1
                            }
            ...
            v.onTagOpen = function(e, f, g, h) {
                ...
                if (a(f)) q.push(f);
                    ...
                    if (e == "br") A.push(f);
                        ...
                        for (;;) {
                            h = (g = u.name) ? CKEDITOR.dtd[g] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                            if (!f.isUnknown && !u.isUnknown && !h[e])
                                if (u.isOptionalClose) v.onTagClose(g);
                                else if (e in b && g in b) {
                                g = u.children;
                                (g = g[g.length - 1]) && g.name == "li" || n(g = new CKEDITOR.htmlParser.element("li"), u);
                                !f.returnPoint && (f.returnPoint = u);
                                u = g
                            } else if (e in CKEDITOR.dtd.$listItem && !r(e, g)) v.onTagOpen(e ==
                                "li" ? "ul" : "dl", {}, 0, 1);
                            else if (g in d && !r(e, g)) {
                                !f.returnPoint && (f.returnPoint = u);
                                u = u.parent
                            } else {
                                g in CKEDITOR.dtd.$inline && q.unshift(u);
            ...
            v.onText = function(a) {
                if ((!u._.hasInlineStarted || A.length) && !k && !p) {
                    a = CKEDITOR.tools.ltrim(a);
                    if (a.length === 0) return
                }
                var e = u.name,
                    f = e ? CKEDITOR.dtd[e] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!p && !f["#"] && e in d) {
                    v.onTagOpen(e in b ? "li" : e == "dl" ? "dd" : e == "table" ? "tr" : e == "tr" ? "td" : "");
                    v.onText(a)
                } else {
                    j();
                    m();
    ...
    (function() {
        ...
        a.prototype = {
            ...
            addMany: function(a,
                c, e) {
                for (var d = [this.findIndex(c), 0], h = 0, m = a.length; h < m; h++) d.push({
                    value: a[h],
                    priority: c,
                    options: e
                });
            ...
            exec: function(a, c) {
                ...
                for (s = 0; s < m; s++) {
                    ...
                    if (!(a.nonEditable && !n.options.applyToAll ||
                        ...
                        if (n === false || e && n && (n.name != i || n.type != j)) return n;
                        n != void 0 && (d[0] = c = n)
                    }
                }
                return c
            ...
            execOnName: function(a, c) {
                for (var e = 0, d = this.rules, h = d.length, m; c && e < h; e++) {
                    m = d[e];
    ...
    (function() {
        function a(a, d) {
                ...
                return function(d) {
                    if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var k = [],
                            ...
                            p, h;
                        if (l)
                            for (o(l, 1) && k.push(l); l;) {
                                if (g(l) && (p = c(l)) && o(p))
                                    if ((h = c(p)) && !g(h)) k.push(p);
                                    else {
                                        f(j).insertAfter(p);
                                        p.remove()
                                    }
                        ...
                        if (k = CKEDITOR.env.opera && !a || (typeof e == "function" ? e(d) !==
                                false : e))
                            if (!j && !CKEDITOR.env.needsBrFiller && d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) k = false;
                            else if (!j && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || d.name in CKEDITOR.dtd.tr || d.name in CKEDITOR.dtd.$listItem)) k = false;
                        else {
                            k = b(d);
            ...
            function o(a, b) {
                if ((!j || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && a.name == "br" && !a.attributes["data-cke-eol"]) return true;
                var c;
                if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(A))) {
                    ...
                    if (!CKEDITOR.env.needsBrFiller && j && (!b || a.parent.name in q)) return true;
                    if (!j)
            ...
            var w = {
                ...
                j = d == "html",
                q = CKEDITOR.tools.extend({}, l),
                t;
            for (t in q) "#" in p[t] || delete q[t];
            for (t in q) w.elements[t] = k(j, a.config.fillEmptyBlocks !== false);
            w.root = k(j);
        ...
        function q(a, b) {
            for (var c = [], e = b.config.protectedSource, d = b._.dataStore || (b._.dataStore = {
                ...
                }), k = 0; k < e.length; k++) a = a.replace(e[k], function(a) {
            ...
            a = a.replace(f, function(a, b, e) {
                return "<\!--" + u + (b ? "{C}" : "") + encodeURIComponent(c[e]).replace(/--/g, "%2D%2D") +
                    "--\>"
            });
                    ...
                    table: function(a) {
                        a.children.slice(0).sort(function(a, b) {
                            ...
                            if (a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type) {
                                ...
                                e = CKEDITOR.tools.indexOf(k, b.name)
                            }
                            if (!(c > -1 && e > -1 && c != e)) {
        ...
        if (CKEDITOR.env.ie) J.attributes.style = function(a) {
    ...
    (function() {
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, c, d) {
            ...
            n && (n.style.width = "1%");
            i.setStyle("height", Math.max(b - (c ? 0 : (d.$.offsetHeight || 0) - (i.$.clientHeight || 0)), 0) + "px");
            n && (n.style.width = "100%");
            this.fire("resize")
        };
    ...
    (function() {
        function a(a) {
            ...
            if (b.config.autoParagraph !== false && b.activeEnterMode != CKEDITOR.ENTER_BR && b.editable().equals(g) && !e.block && k.collapsed && !k.getCommonAncestor().isReadOnly()) {
                e = k.clone();
                ...
                if (!g.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) {
        ...
        function g(a) {
            ...
            if (d.startPath().contains(g)) {
                var a =
                    function(a) {
                        return function(d, e) {
                            e && (d.type == CKEDITOR.NODE_ELEMENT && d.is(g)) && (b = d);
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                attachListener: function(a, b, c, d, e, k) {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    if (k)
                        for (;
                            (l = b.getCommonAncestor(0, 1)) && (g = CKEDITOR.dtd[l.getName()]) && (!g || !g[e]);)
                    ...
                    if (this.insertElementIntoRange(a, e)) {
                        ...
                        if (g)
                            if ((g = a.getNext(function(a) {
                                    return c(a) && !j(a)
                                })) && g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.$block)) g.getDtd()["#"] ? e.moveToElementEditStart(g) : e.moveToElementEditEnd(a);
                            else if (!g && d != CKEDITOR.ENTER_BR) {
                            g = e.fixBlock(true, d == CKEDITOR.ENTER_DIV ?
                                "div" : "p");
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in p) {
                                var b = a.getSelection(),
                                    ...
                                    h = o.startPath(),
                                    j, i, m, c = c == 8;
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (e = b.getSelectedElement()) || (e = g(b))) {
                                    a.fire("saveSnapshot");
                                    o.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START);
                                    e.remove();
                                    o.select();
                                    a.fire("saveSnapshot");
                                    d = 1
                                } else if (o.collapsed)
                                    if ((j = h.block) && (m = j[c ? "getPrevious" : "getNext"](n)) && m.type == CKEDITOR.NODE_ELEMENT && m.is("table") &&
                                        o[c ? "checkStartOfBlock" : "checkEndOfBlock"]()) {
                                        a.fire("saveSnapshot");
                                        o[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && j.remove();
                                        o["moveToElementEdit" + (c ? "End" : "Start")](m);
                                        o.select();
                                        a.fire("saveSnapshot");
                                        d = 1
                                    } else if (h.blockLimit && h.blockLimit.is("td") && (i = h.blockLimit.getAscendant("table")) && o.checkBoundaryOfElement(i, c ? CKEDITOR.START : CKEDITOR.END) && (m = i[c ? "getPrevious" : "getNext"](n))) {
                                    a.fire("saveSnapshot");
                                    o["moveToElementEdit" + (c ? "End" : "Start")](m);
                                    o.checkStartOfBlock() && o.checkEndOfBlock() ? m.remove() :
                                        o.select();
                                    a.fire("saveSnapshot");
                                    d = 1
                                } else if ((i = h.contains(["td", "th", "caption"])) && o.checkBoundaryOfElement(i, c ? CKEDITOR.START : CKEDITOR.END)) d = 1
                            }
                            return !d
                        });
        ...
        var r = function() {
                ...
                function b(c, d) {
                    ...
                    e = d.range.startPath();
                    for (var h =
                            l[h.getName()], j = 0, i = c.getChildren(), t = i.count(), m = -1, n = -1, y = 0, s = e.contains(l.$list); j < t; ++j) {
                        e = i.getItem(j);
                        if (a(e)) {
                            g = e.getName();
                            if (s && g in CKEDITOR.dtd.$list) p = p.concat(b(e, d));
                            else {
                                o = !!h[g];
                                if (g == "br" && e.data("cke-eol") && (!j || j == t - 1)) {
                                    y = (k = j ? p[j - 1].node : i.getItem(j + 1)) && (!a(k) || !k.is("br"));
                                    k = k && a(k) && l.$block[k.getName()]
                                }
                                m == -1 && !o && (m = j);
                                o || (n = j);
                                p.push({
                ...
                function d(b, c) {
                    var e = [],
                        ...
                        o, p = 0,
                        h = l[c],
                        j = !b.is(l.$inline) || b.is("br");
                    for (j && e.push(" "); p < g; p++) {
                        o = k.getItem(p);
                        a(o) && !o.is(h) ? e = e.concat(d(o, c)) : e.push(o)
                    }
                    j && e.push(" ");
                    return e
                }
                ...
                function g(b, c, d, e) {
                    ...
                    if ((l = (new CKEDITOR.dom.walker(k)).next()) &&
                        a(l) && h[l.getName()] && (o = l.getPrevious()) && a(o) && !o.getParent().equals(b.startContainer) && d.contains(o) && e.contains(l) && l.isIdentical(o)) {
                        l.moveChildren(o);
                        l.remove();
                        g(b, c, d, e)
                    }
                ...
                var l = CKEDITOR.dtd,
                    ...
                    o = CKEDITOR.tools.extend({}, l.$inline);
                delete o.br;
                return function(h, i, t) {
                    var n = h.editor;
                    h.getDocument();
                    var s = n.getSelection().getRanges()[0],
                        r = false;
                    ...
                    if (!s.checkReadOnly()) {
                        var w = (new CKEDITOR.dom.elementPath(s.startContainer, s.root)).blockLimit || s.root,
                            i = {
                                type: i,
                                dontFilter: r,
                                editable: h,
                            ...
                            r = i.mergeCandidates,
                            x, D, E, z;
                        if (i.type == "text" && n.shrink(CKEDITOR.SHRINK_ELEMENT, true, false)) {
                            x = CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>", n.document);
                            n.insertNode(x);
                            n.setStartAfter(x)
                        }
                        D = new CKEDITOR.dom.elementPath(n.startContainer);
                        i.endPath = E = new CKEDITOR.dom.elementPath(n.endContainer);
                        if (!n.collapsed) {
                            var w = E.block || E.blockLimit,
                                U = n.getCommonAncestor();
                            w && (!w.equals(U) && !w.contains(U) && n.checkEndOfBlock()) && i.zombies.push(w);
                            n.deleteContents()
                        }
                        for (;
                            (z = a(n.startContainer) &&
                                n.startContainer.getChild(n.startOffset - 1)) && a(z) && z.isBlockBoundary() && D.contains(z);) n.moveToPosition(z, CKEDITOR.POSITION_BEFORE_END);
                        g(n, i.blockLimit, D, E);
                        if (x) {
                            n.setEndBefore(x);
                            n.collapse();
                            x.remove()
                        ...
                        x = n.startPath();
                        if (w = x.contains(e, false, 1)) {
                            n.splitElement(w);
                            i.inlineStylesRoot = w;
                            i.inlineStylesPeak = x.lastElement
                        }
                        x = n.createBookmark();
                        (w = x.startNode.getPrevious(c)) && a(w) && e(w) && r.push(w);
                        (w = x.startNode.getNext(c)) && a(w) && e(w) && r.push(w);
                        for (w = x.startNode;
                        ...
                        if (x = t) {
                            ...
                            if (i.type == "text" && i.inlineStylesRoot) {
                                z = i.inlineStylesPeak;
                                n = z.getDocument().createText("{cke-peak}");
                                for (r = i.inlineStylesRoot.getParent(); !z.equals(r);) {
                                    n = n.appendTo(z.clone());
                                    z = z.getParent()
                                }
                                t = n.getOuterHtml().split("{cke-peak}").join(t)
                            }
                            z = i.blockLimit.getName();
                            if (/^\s+|\s+$/.test(t) && "span" in CKEDITOR.dtd[z]) var O = '<span data-cke-marker="1">&nbsp;</span>',
                                t = O + t + O;
                            t = i.editor.dataProcessor.toHtml(t, {
                                context: null,
                                fixForBody: false,
                            ...
                            if ((O = x.startPath().block) && !(O.getChildCount() == 1 && O.getBogus())) a: {
                                var v;
                                if (z.getChildCount() == 1 && a(v = z.getFirst()) && v.is(j)) {
                                    O = v.getElementsByTag("*");
                                    x = 0;
                                    for (r = O.count(); x < r; x++) {
                                        n = O.getItem(x);
                                        if (!n.is(o)) break a
                        ...
                        if (x) {
                            ...
                            var F, P, r = n = 0,
                                L, R;
                            D = v.startContainer;
                            var w = i.endPath.elements[0],
                                S;
                            E = w.getPosition(D);
                            U = !!w.getCommonAncestor(D) && E != CKEDITOR.POSITION_IDENTICAL && !(E & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                            D = b(i.dataWrapper, i);
                            for (k(D, v); x < D.length; x++) {
                                E = D[x];
                                if (B = E.isLineBreak) {
                                    B = v;
                                    L = t;
                                    var M = void 0,
                                        V = void 0;
                                    if (E.hasBlockSibling) B = 1;
                                    else {
                                        M = B.startContainer.getAscendant(l.$block, 1);
                                        if (!M || !M.is({
                                                div: 1,
                                                p: 1
                                            })) B = 0;
                                            ...
                                            V = M.getPosition(L);
                                            if (V == CKEDITOR.POSITION_IDENTICAL || V == CKEDITOR.POSITION_CONTAINS) B = 0;
                                            else {
                                                L = B.splitElement(M);
                                                B.moveToPosition(L,
                                                    CKEDITOR.POSITION_AFTER_START);
                                ...
                                if (B) r = x > 0;
                                    ...
                                    B = v.startPath();
                                    if (!E.isBlock && i.editor.config.autoParagraph !== false && (i.editor.activeEnterMode != CKEDITOR.ENTER_BR && i.editor.editable().equals(B.blockLimit) && !B.block) && (P = i.editor.activeEnterMode != CKEDITOR.ENTER_BR && i.editor.config.autoParagraph !== false ? i.editor.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : false)) {
                                        P = O.createElement(P);
                                        P.appendBogus();
                                        v.insertNode(P);
                                        CKEDITOR.env.needsBrFiller && (K = P.getBogus()) && K.remove();
                                        v.moveToPosition(P,
                                            CKEDITOR.POSITION_BEFORE_END)
                                    }
                                    if ((B = v.startPath().block) && !B.equals(F)) {
                                        if (K = B.getBogus()) {
                                            K.remove();
                                            z.push(B)
                                        }
                                    ...
                                    if (n && E.isElement) {
                                        B = v.startContainer;
                                        for (L = null; B && !l[B.getName()][E.name];) {
                                            if (B.equals(t)) {
                                                B = null;
                                                break
                                            }
                                        ...
                                        if (B) {
                                            ...
                                            B = x == D.length - 1;
                                            L = d(E.node, L);
                                            for (var M = [], V = L.length, Y = 0, $ = void 0, aa = 0, ba = -1; Y < V; Y++) {
                                                $ = L[Y];
                                                if ($ == " ") {
                                                    if (!aa && (!S || Y)) {
                                    ...
                                    if (S) {
                                        for (; B = S.pop();) v.insertNode(B);
                                        S = 0
                                    } else v.insertNode(E.node);
                                    if (E.lastNotAllowed && x < D.length - 1) {
                                        (R = U ? w : R) && v.setEndAt(R, CKEDITOR.POSITION_AFTER_START);
                                        n = 0
                                    }
                                    v.collapse()
                                }
                            ...
                            i.dontMoveCaret = r;
                            i.bogusNeededBlocks = z
                        }
                        K = i.range;
                        var W;
                        R = i.bogusNeededBlocks;
                        for (S = K.createBookmark(); F = i.zombies.pop();)
                            if (F.getParent()) {
                                P = K.clone();
                                P.moveToElementEditStart(F);
                                P.removeEmptyBlocksAtEnd()
                            }
                        if (R)
                            for (; F = R.pop();) CKEDITOR.env.needsBrFiller ? F.appendBogus() :
                                F.append(K.document.createText(" "));
                        for (; F = i.mergeCandidates.pop();) F.mergeSiblings();
                        K.moveToBookmark(S);
                        if (!i.dontMoveCaret) {
                            for (F = a(K.startContainer) && K.startContainer.getChild(K.startOffset - 1); F && a(F) && !F.is(l.$empty);) {
                                if (F.isBlockBoundary()) K.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END);
                                    ...
                                    W = K.clone();
                                    W.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END)
                                }
                                F = F.getLast(c)
                            }
                            W && K.moveToRange(W)
            ...
            v = function() {
                ...
                return function(d) {
                    ...
                    k || (k = e);
                    if (k.is("table")) {
                        d.setStartAt(k, CKEDITOR.POSITION_BEFORE_START);
                        d.collapse(true);
                        k.remove()
                    } else {
                        k.is({
                        ...
                        k.is("tr") && (k = b(k, k.getParent().is("thead") ? "th" : "td", l));
                        (e = k.getBogus()) && e.remove();
                        d.moveToPosition(k,
    ...
    (function() {
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                ...
                f.attachListener(f, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() {
                    p && CKEDITOR.env.webkit && (p = e._.previousActive && e._.previousActive.equals(b.getActive()));
                    e.unlockSelection(p);
                    p = 0
                }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || CKEDITOR.env.opera || j) {
                    ...
                    q ? f.attachListener(f, "beforedeactivate", m, null, null, -1) : f.attachListener(e, "selectionCheck", m, null, null, -1);
                    f.attachListener(f,
                ...
                if (CKEDITOR.env.ie && !j) {
                    ...
                    f.attachListener(f, "mousedown", function(a) {
                        if (a.data.$.button == 2) {
                            ...
                            if (!a || a.getType() == CKEDITOR.SELECTION_NONE) w = e.window.getScrollPosition()
                        }
                    });
                    f.attachListener(f, "mouseup", function(a) {
                        if (a.data.$.button == 2 && w) {
                            e.document.$.documentElement.scrollLeft = w.x;
                            e.document.$.documentElement.scrollTop = w.y
                        }
                        w = null
                    });
                ...
                f.attachListener(f, "keydown", i(e), null, null, -1)
            });
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            if (CKEDITOR.env.webkit)(b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && m(a, b);
                ...
                if (q) b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && m(a, null, true);
                else {
            ...
            if (d)
                if (d.getRangeAt) f = (g = d.rangeCount && d.getRangeAt(0)) && new CKEDITOR.dom.node(g.commonAncestorContainer);
                    ...
                    f = g && CKEDITOR.dom.element.get(g.item && g.item(0) ||
                        g.parentElement())
                }
            ...
            getRanges: function() {
                var a = q ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), i = 0, j = e.length - 1, l = -1, n, p; i <= j;) {
                            l = Math.floor((i + j) / 2);
                            f = e[l];
                        ...
                        for (; h > 0;) try {
                            g = f[n > 0 ? "previousSibling" : "nextSibling"];
                            if (g.nodeType == CKEDITOR.NODE_TEXT) {
                                h = h - g.nodeValue.length;
                                p = g
                            }
                        ...
                        return {
                            container: p,
                            offset: n > 0 ? -h : p.nodeValue.length + h
                        }
                    };
                    return function() {
                    ...
                    if (this.isLocked) {
                        ...
                        a: {
                            ...
                            if (a.length == 1 && !(j = a[0]).collapsed && (h = j.getEnclosedNode()) && h.type == CKEDITOR.NODE_ELEMENT) {
                                j = j.clone();
                                j.shrink(CKEDITOR.SHRINK_ELEMENT,
                                    true);
                        ...
                        if (h) this.fake(h);
                            ...
                            if (q) {
                                ...
                                var a = h.collapsed,
                                    n, m, r;
                                if ((d = h.getEnclosedNode()) && d.type == CKEDITOR.NODE_ELEMENT && d.getName() in u && (!d.is("a") || !d.getText())) try {
                                ...
                                if (f) {
                                    ...
                                    n = !(n && n.getText && n.getText().match(i)) && (m || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br"));
                                    m = h.document.createElement("span");
                                    m.setHtml("&#65279;");
                                    m.insertBefore(b);
                                ...
                                for (r = 0; r < a.length; r++) {
                                    if (r < a.length - 1) {
                                        ...
                                        if (!i.collapsed) {
                                            ...
                                            i = i.getEnclosedNode();
                                            if (m.isReadOnly() || i && i.isReadOnly()) {
                                    ...
                                    n = h.startContainer;
                                    if (CKEDITOR.env.opera && h.collapsed && n.type == CKEDITOR.NODE_ELEMENT) {
                                        i = n.getChild(h.startOffset - 1);
                                        j = n.getChild(h.startOffset);
                                        if (!i && !j && n.is(CKEDITOR.dtd.$removeEmpty) || i && i.type == CKEDITOR.NODE_ELEMENT || j && j.type == CKEDITOR.NODE_ELEMENT) {
                                    ...
                                    if (h.collapsed && CKEDITOR.env.webkit && c(h)) {
                                        ...
                                        h.insertNode(i);
                                        if ((n = i.getNext()) && !i.getPrevious() &&
                                            n.type == CKEDITOR.NODE_ELEMENT && n.getName() == "br") {
                                            g(this.root);
                                            h.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)
                                        } else h.moveToPosition(i, CKEDITOR.POSITION_AFTER_END)
                                    }
                                    m.setStart(h.startContainer.$, h.startOffset);
                                    try {
                                        m.setEnd(h.endContainer.$, h.endOffset)
                                    } catch (w) {
        ...
        if (!b) {
            ...
            this.on("selectionChange", function(a) {
                for (var d = 0; d < b.length; d++) {
                    var g = b[d],
                        h = g.style.checkActive(a.data.path) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    g.fn.call(this, h)
                }
            })
        }
    ...
    (function() {
                ...
                for (o.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o;) {
                    ...
                    if (o.equals(m)) {
                        ...
                        var p = o.type == CKEDITOR.NODE_ELEMENT ? o.getName() : null,
                            q = p && o.getAttribute("contentEditable") == "false",
                            s = p && o.getAttribute("data-nostyle");
                        if (p && o.data("cke-bookmark")) {
                            o =
                                o.getNextSourceNode(true);
                            continue
                        }
                        if (q && j && CKEDITOR.dtd.$block[p])
                            for (var t = o, u = c(t), y = void 0, C = u.length, G = 0, t = C && new CKEDITOR.dom.range(t.getDocument()); G < C; ++G) {
                                var y = u[G],
                                    J = CKEDITOR.filter.instances[y.data("cke-filter")];
                                if (J ? J.check(this) : 1) {
                                    t.selectNodeContents(y);
                                    d.call(this, t)
                                }
                            }
                        u = p ? !k[p] || s ? 0 : q && !j ? 0 : (o.getPosition(m) | N) == N && (!g.childRule || g.childRule(o)) : 1;
                        if (u)
                            if ((u = o.getParent()) && ((u.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(u))) {
                                ...
                                p = o.type;
                                if (p == CKEDITOR.NODE_TEXT || q || p == CKEDITOR.NODE_ELEMENT && !o.getChildCount()) {
                                    for (var p = o, X;
                                        (i = !p.getNext(I)) && (X = p.getParent(), k[X.getName()]) && (X.getPosition(l) | H) == H && (!g.childRule || g.childRule(X));) p = X;
                                    r.setEndAfter(p)
                                }
                            } else i = true;
                        else i = true;
                        o = o.getNextSourceNode(s || q)
                    }
                    if (i && r && !r.collapsed) {
                        for (var i = A(this, e), q = i.hasAttributes(), s = r.getCommonAncestor(), p = {}, u = {}, y = {}, C = {}, T, Q, Z; i && s;) {
                            if (s.getName() == f) {
                                for (T in g.attributes)
                                    if (!C[T] &&
                                        (Z = s.getAttribute(Q))) i.getAttribute(T) == Z ? u[T] = 1 : C[T] = 1;
                                for (Q in g.styles)
                                    if (!y[Q] && (Z = s.getStyle(Q))) i.getStyle(Q) == Z ? p[Q] = 1 : y[Q] = 1
                            }
                            s = s.getParent()
                        }
                        for (T in u) i.removeAttribute(T);
                        for (Q in p) i.removeStyle(Q);
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, i; h < e.elements.length && (i = e.elements[h]); h++) {
                    ...
                    if (this.checkElementRemovable(i)) {
                        ...
                        if (a.collapsed && (a.checkBoundaryOfElement(i, CKEDITOR.END) || (j = a.checkBoundaryOfElement(i, CKEDITOR.START)))) {
                            ...
                            i.mergeSiblings();
                            i.is(this.element) ? r.call(this, i) : f(i, k(this)[i.getName()])
                        }
                    }
                }
                if (g) {
                ...
                for (e = d; !e.equals(n);) {
                    ...
                    if (e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e)) {
                        e.getName() == this.element ? r.call(this, e) : f(e, k(this)[e.getName()]);
        ...
        function j(a, b) {
            ...
            if (d && !e) {
                ...
                b = e
            } else f ? b = s(c ? [a.getHtml()] : i(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b,
                    h;
        ...
        CKEDITOR.style = function(a, b) {
            ...
            c = this.element = a.element ? typeof a.element == "string" ? a.element.toLowerCase() :
                a.element : "*";
            this.type = a.type || (y[c] ? CKEDITOR.STYLE_BLOCK : o[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
        ...
        CKEDITOR.editor.prototype.applyStyle = function(a) {
            a.checkApplicable(this.elementPath()) && t.call(a, this.getSelection())
        };
        CKEDITOR.editor.prototype.removeStyle = function(a) {
            a.checkApplicable(this.elementPath()) && t.call(a, this.getSelection(), 1)
        };
        CKEDITOR.style.prototype = {
            apply: function(a) {
                t.call(this, a.getSelection())
            },
            remove: function(a) {
                t.call(this, a.getSelection(), 1)
            },
        ...
        CKEDITOR.dom.elementPath = function(b, e) {
            ...
            do
                if (j.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!h) {
                        i = j.getName();
                        j.getAttribute("contenteditable") == "true" ? h = j : !g && d[i] && (g = j);
                        if (a[i]) {
                            var n;
                            if (n = !g) {
                                if (i = i == "div") {
    ...
    (function() {
        function a(a, c, d) {
            var g = a.serializable,
                ...
                j = g ? c.document.getById(a.startNode) : a.startNode,
        ...
        var d = {
            ...
            createBookmarks: function(b) {
                for (var c = [], d, g = 0; g < this.length; g++) {
                    c.push(d = this[g].createBookmark(b, true));
    ...
    */
                ...
                file: function(b, a, d) {
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
                            ...
                            var b = ['<iframe allowfullscreen="1" frameborder="0" allowtransparency="0" class="cke_dialog_ui_input_file" role="presentation" id="',
    ...
    (function() {
        ...
        function R(a) {
            ...
            if (CKEDITOR.env.ie && !CKEDITOR.env.ie6Compat) {
                ...
                CKEDITOR.dom.element.createFromHtml('<iframe allowfullscreen="1" frameBorder="0" class="cke_iframe_shim" src="' + d + '" tabIndex="-1"></iframe>').appendTo(b.getParent())
            }
            c.unselectable();
            e.unselectable();
            return {
    ...
    (function() {
        ...
        var f = CKEDITOR.addTemplate("panel",
            ...
            g = CKEDITOR.addTemplate("panel-frame", '<iframe id="{id}" allowfullscreen="1" class="cke_panel_frame" role="presentation" frameborder="0" src="{src}"></iframe>'),
        ...
        CKEDITOR.plugins.add("pagebreak", {
            ...
            init: function(a) {
                a.blockless || (a.addCommand("pagebreak", CKEDITOR.plugins.pagebreakCmd), a.ui.addButton && a.ui.addButton("PageBreak", {
                    ...
                    command: "pagebreak",
                    toolbar: "insert,70"
                }), (CKEDITOR.env.opera || CKEDITOR.env.webkit) && a.on("contentDom", function() {
