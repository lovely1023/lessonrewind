...
;(function($) {
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			...
			if (fileExists('http://lessonrewind.com/public/plugins/ScriptCam-master/ScriptCam-master/scriptcam.swf')) {
				
				swfobject.embedSWF('http://lessonrewind.com/public/plugins/ScriptCam-master/ScriptCam-master/scriptcam.swf', opts.id, newWidth, newHeight, '11.6', false, opts, params);
			}
			else {
